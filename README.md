...
![Project_1_dashboard(gif)](https://github.com/user-attachments/assets/ca016c33-7a88-40b4-95a5-21a60f47be9f)
...
### Dashboard File
My final dashboard is in [Data_Analysis_Dashboard_Project1.xlsx](Data_Analysis_Dashboard_Project1.xlsx).
...
### Data Jobs Dataset
I have no ownership of the job Dataset which was used, it was taken from [Luke Barousse's Github](https://github.com/lukebarousse/Excel_Data_Analytics_Course/tree/main) . The dataset is from 2023. It includes 
